                                            ...
                                            <div className="row mt-50 align-items-end">
                                                ...
                                                <div className="col-lg-3 col-md-4">
                                                    <div className="box-share border-gray-800">
                                                        <h6 className="d-inline-block color-gray-500 mr-10">Share</h6><a className="icon-media icon-fb" href="#"></a><a className="icon-media icon-tw" href="#"></a><a className="icon-media icon-printest" href="#"></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="row">
                                                <div className="col-lg-8">
                                                    <div className="content-detail border-gray-800">
                                                        ...
                                                        <div className="mt-20 mb-20"><img className="img-bdrd-16" src={img12} alt="Genz"/></div>
                                                    ...
                                                    <div className="box-comments border-gray-800">
                                                        ...
                                                        <div className="list-comments-single">
                                                            ...
                                                            <div className="item-comment">
                                                                <div className="comment-left">
                                                                    <div className="box-author mb-20"><img src={img12} alt="Genz"/>
                                                                        <div className="author-info">
                                                    ...
                                                    <div className="box-form-comments mb-50">
                                                        ...
                                                        <div className="box-forms">
                                                            <form action="#">
                                                                <textarea className="form-control bg-gray-850 border-gray-800 bdrd16 color-gray-500" name="comment" rows="5" placeholder="Write a comment"></textarea>
                                                                <div className="row mt-20">
                                                                    ...
                                                                    <div className="col-sm-6 text-end"><a className="btn btn-linear">Post Comment</a></div>
                                                                </div>
                                                            </form>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="col-lg-4">
                                                    <div className="sidebar">
                                                        <div className="box-sidebar bg-gray-850 border-gray-800">
                                                            ...
                                                            <div className="content-sidebar">
                                                                <div className="list-cats">
                                                                    {
                                                                        tagCount.map(tag => (
                                                                            <div className="item-cats border-gray-800 wow animate__animated animate__fadeIn" key={tag.id}>
                                                                                <div className="cat-left">
                                                                                    <div className="image-cat"><a href="#"><img src={tag.image ? tag.image : cat5} alt="Genz"/></a></div>
                                                                                    <div className="info-cat"><a className="color-gray-500 text-xl" href="#">{tag.name}</a></div>
                                                                                </div>
                                                                                <div className="cat-right"><a className="btn btn-small text-sm color-gray-500 bg-gray-800" href="#">{tag.posts}
                                                                                    posts</a></div>
                                                                            </div>
                                                                        ))
                                                                    }
                                                        ...
                                                        <div className="box-sidebar bg-gray-850 border-gray-800">
                                                            ...
                                                            <div className="content-sidebar pb-20"><a className="btn btn-tags bg-gray-850 border-gray-800 mr-10 mb-10 bdrd16 wow animate__animated animate__fadeIn" href="blog-archive.html">Technology</a><a className="btn btn-tags bg-gray-850 border-gray-800 mr-10 mb-10 bdrd16 wow animate__animated animate__fadeIn" href="blog-archive.html">Travel</a><a className="btn btn-tags bg-gray-850 border-gray-800 mr-10 mb-10 bdrd16 wow animate__animated animate__fadeIn" href="blog-archive.html">Interior</a><a className="btn btn-tags bg-gray-850 border-gray-800 mr-10 mb-10 bdrd16 wow animate__animated animate__fadeIn" href="blog-archive.html">Minimal</a><a className="btn btn-tags bg-gray-850 border-gray-800 mr-10 mb-10 bdrd16 wow animate__animated animate__fadeIn" href="blog-archive.html">Plant</a><a className="btn btn-tags bg-gray-850 border-gray-800 mr-10 mb-10 bdrd16 wow animate__animated animate__fadeIn" href="blog-archive.html">Nature</a><a className="btn btn-tags bg-gray-850 border-gray-800 mr-10 mb-10 bdrd16 wow animate__animated animate__fadeIn" href="blog-archive.html">Business</a><a className="btn btn-tags bg-gray-850 border-gray-800 mr-10 mb-10 bdrd16 wow animate__animated animate__fadeIn" href="blog-archive.html">Animal</a><a className="btn btn-tags bg-gray-850 border-gray-800 mr-10 mb-10 bdrd16 wow animate__animated animate__fadeIn" href="blog-archive.html">Healthy</a><a className="btn btn-tags bg-gray-850 border-gray-800 mr-10 mb-10 bdrd16 wow animate__animated animate__fadeIn" href="blog-archive.html">Space</a></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
